...
- Improved devicegen_std packaging (it is now possible to import a standard DeviceGenerator using ``from devicegen_std import DeviceGenerator``).
...
First official beta release of devicegen_std.